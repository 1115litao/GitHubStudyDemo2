            ...
            textViews[i].setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(cuPosition == index)
                    {
                        ...
                        horizontalScrollView.smoothScrollBy(index * dip2px(getContext(), twidth) - leftm, 0);
                    }
                    if(margleft == 0)
                    {
    ...
    public void setViewPager(final Context context, String[] titles, ViewPager viewPager, final int unselectedcolor, final int setectedcolor, int txtUnselectedSize, final int txtSelectedSize, final int widOffsets, boolean smoothScroll, int splilinecolor, final float splilinewidth, float topoffset, float bottomoffset, final int titlewidth)
    {
        ...
        viewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
               ...
               int moveto =  (position * dip2px(context, twidth) - leftm)%dip2px(context, measuredWidth);

                if(((position+1) * dip2px(context, twidth) - leftm)>measuredWidth){
                    Log.i("aaa","index ======"+(position+1) * dip2px(getContext(), twidth)+"measuredWidth==="+measuredWidth+"moveto======"+moveto);
                    horizontalScrollView.smoothScrollTo((moveto-measuredWidth), 0);
                }else{
        ...
        horizontalScrollView.setOnScrollChangedListener(new OnScrollChangedListener() {
          ...
          //      Log.i("aaa","l:" + l + ",t:" + t + ",oldl:" + oldl + "oldt:" + oldt);
           /*     int offset = l - soldl;
                soldl = l;
                sum += offset;
